...
QT_MOC_LITERAL(7, 70, 10), // "slotRetrun"
QT_MOC_LITERAL(8, 81, 9) // "arrReturn"

    },
    "CLocalServer\0signalLog\0\0st\0signalReadAll\0"
    "arrRead\0slotAcceptConnection\0slotRetrun\0"
    "arrReturn"
};
...
void CLocalServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CLocalServer *_t = static_cast<CLocalServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 3: _t->slotRetrun((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CLocalServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CLocalServer::signalLog)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CLocalServer::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CLocalServer::signalReadAll)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CLocalServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CLocalServer.data,
      qt_meta_data_CLocalServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CLocalServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLocalServer.stringdata0))
        return static_cast<void*>(const_cast< CLocalServer*>(this));
