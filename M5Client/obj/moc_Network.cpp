...
#include "../../M5Lib/include/Network.h"
...
void Network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Network::signalLog)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Network::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Network::signalReadAll)) {
                *result = 1;
                return;
            }
        }
