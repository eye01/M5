...
void Ipc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Ipc::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ipc::signalLog)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Ipc::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ipc::signalReadAll)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Ipc::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ipc.data,
